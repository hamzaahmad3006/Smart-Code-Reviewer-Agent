                ...
                <div className="bg-slate-900/40 border border-slate-700/50 rounded-2xl overflow-hidden backdrop-blur-md">
                    ...
                    <form onSubmit={handleSendMessage} className="p-4 bg-slate-900/60 border-t border-slate-800 flex gap-3">
                        <input
                            ...
                            disabled={isSending}
                            className="bg-slate-950/50 border border-slate-700/50 rounded-xl px-4 py-2 text-sm text-slate-200 focus:outline-hidden focus:border-primary-500/50 grow transition-all"
                        />
                        <button
                            type="submit"
